    ...
    return (
        <div className='flex flex-col lg:flex-row min-h-screen w-full justify-center items-center bg-black p-8 sm:text-5xl md:text-6xl lg:text-6xl'>
            ...
            <div className='w-full lg:w-1/2 flex flex-col gap-10'>
                ...
                <div>
                    <button className='bg-red-600 text-white px-5 py-2 hover:bg-red-700 rounded hover:scale-110 transition-all duration-300 ease-in-out text-4xl' >ADD TO BAG</button>
                </div>
